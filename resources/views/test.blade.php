...
@section('content')
    ...
    <div style="line-height: 1" class="mt-3 pb-4 has-text-centered is-italic is-size-3-mobile is-size-2">
            ...
            <div class="column is-8">
                <article class="media">
                    ...
                    <div class="media-content is-size-5-mobile is-size-4-tablet px-5" style="line-height: 1.2">
                        ...
                        <p class=" p-2 is-size-3 is-italic">Let us shop, stock, and store for you!</p>
